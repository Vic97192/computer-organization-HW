#define macro_fft_cycle_count fft_cycle_count = \
(add_cnt*add_CPI+\
sub_cnt*sub_CPI+\
mul_cnt*mul_CPI+\
div_cnt*div_CPI+\
...
#define macro_calc_fft_ratio fft_ratio = (add_cnt*add_CPI+\
    sub_cnt*sub_CPI+\
    mul_cnt*mul_CPI+\
    div_cnt*div_CPI+\
    others_cnt*others_CPI+\
...
#define macro_arraymul_vector_cycle_count arraymul_vector_cycle_count = \
(add_cnt*add_CPI+\
sub_cnt*sub_CPI+\
mul_cnt*mul_CPI+\
div_cnt*div_CPI+\
...
#define macro_calc_arraymul_double_ratio arraymul_baseline_ratio = \
(add_cnt*add_CPI+\
    sub_cnt*sub_CPI+\
    mul_cnt*mul_CPI+\
    div_cnt*div_CPI+\
